...
class Ui_ExifViewer(object):
    def setupUi(self, ExifViewer):
        ...
        self.ExifDataTab.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        ...
        self.ExifDataTab.horizontalHeader().setDefaultSectionSize(100)
        ...
        self.widgetImg.setMaximumSize(QtCore.QSize(1000, 16777215))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.image.setMaximumSize(QtCore.QSize(1000, 16777215))
        font = QtGui.QFont()
